<template>
  <main>
    <section id="category" class="w-full px-16 py-[60px] grid grid-cols-12 gap-6">
      <div class="col-span-2 space-y-10">
        ...
        <div>
          ...
          <div class="mt-2">
            <localCategoryColorPicker :colors="['#000', '#E90A0A', '#F6C65C', '#fff', '#64c108', '#667b8c', '#55ffaa', '#781ecd']" />
          </div>
        </div>
        <div>
