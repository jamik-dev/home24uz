<template>
  <svg width="22" height="20" viewBox="0 0 22 20" :fill="fill == '#FF6418' ? '#FF6418' : 'none'" xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" clip-rule="evenodd"
      ...
      :stroke="fill" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M14.7394 5.05302C15.8047 5.39332 16.5616 6.34973 16.6562 7.47501" :stroke="fill == '#FF6418' ? '#fff' : '#020105'" stroke-width="1.5"
